...
public static partial class LoggerMessages
{
    [LoggerMessage(
        ...
        Message = "An error occurred while fetching product questions."
    )]
    ...
    [LoggerMessage(
        EventId = 1048,
        Level = LogLevel.Error,
        Message = "An error occurred while creating product question."
    )]
    ...
    [LoggerMessage(
        EventId = 1049,
        Level = LogLevel.Error,
        Message = "An error occurred while answering product question."
    )]
