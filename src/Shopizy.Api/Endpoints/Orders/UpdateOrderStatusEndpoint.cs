...
public class UpdateOrderStatusEndpoint : ApiEndpoint
{
    ...
    {
        app.MapPatch(
                "api/v1.0/admin/orders/{id:guid}/status",
                async (
                    Guid id,
                    [FromBody] Contracts.Order.OrderStatus status,
                ...
                ) =>
                {
                    return await HandleAsync(
                        ...
                        new UpdateOrderStatusCommand(
                            ...
                            id,
                            (Domain.Orders.Enums.OrderStatus)(int)status
                        ),
                        success =>
                            Results.Ok(SuccessResult.Success("Order status updated successfully.")),
