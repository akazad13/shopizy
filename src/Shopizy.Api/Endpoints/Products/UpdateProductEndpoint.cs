...
public class UpdateProductEndpoint : ApiEndpoint
{
    public override void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapPut(
                ...
                {
                    var command = mapper.Map<UpdateProductCommand>(
                        (currentUser.GetCurrentUserId(), productId, request)
                    );
                    ...
                    return await HandleAsync(
                        ...
                        command,
                        success =>
                            Results.Ok(SuccessResult.Success("Successfully updated product.")),
