...
public static partial class CustomErrors
{
    public static class User
    {
        public static DomainError DuplicateEmail =>
            DomainError.Conflict(code: "User.DuplicateEmail", description: "Email is already in use.");
        ...
        public static DomainError InvalidName =>
            DomainError.Validation(code: "User.InvalidName", description: "Invalid first/last name.");

        public static DomainError InvalidPhoneFormat =>
            DomainError.Validation(code: "User.InvalidPhoneFormat", description: "Invalid phone format.");
        public static DomainError InvalidEmailFormat =>
            DomainError.Validation(code: "User.InvalidEmailFormat", description: "Invalid email format.");
    }
}
